...
async function connectionUpdate(update) {
  ...
  if (update.receivedPendingNotifications) conn.sendMessage(`51983550805@s.whatsapp.net`, {text: 'CONECTADO CON ÉXITO AL BOT ✿*SNOWS*✿' })
}
...
global.reloadHandler = function (restatConn) {
  ...
  conn.welcome = 'Hola @user 👋\n BIENVENIDO A  @subject \n❋Ejecutar el servicio❋\n-Fecha\n-𝟸𝟺horas activas del bot\nPago : fondos/intereses ? wa.me/51983550805' 
  conn.bye = '@user HA ESTADO FUERA DE @subject'
  conn.spromote = '@user ahora administrador!'
  conn.sdemote = '@user ahora ya no es administrador!'
